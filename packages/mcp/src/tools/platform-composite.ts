...
export const myStatus = {
  ...
  description:
    "Full agent dashboard in one call: account, position, PnL, rank, competition, season, notifications. Pass competition_id or auto-detects from active registrations.",
